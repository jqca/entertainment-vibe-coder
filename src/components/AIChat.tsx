      ...
      <div style={{ flex: '1', overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        {history.length === 0 && (
          <div style={{ textAlign: 'center', opacity: 0.7, marginTop: '20px' }}>
            ...
            <p style={{ marginBottom: '16px' }}>エンタメ Quantum Copilot へようこそ。<br/>以下のユースケースから実装を選択してください：</p>
          </div>
        )}
            ...
            <button
              ...
              onClick={() => {
                ...
                fetch('/api/track', {
                  ...
                  body: JSON.stringify({ app_id: 'entertainment', usecase_id: uc.id, usecase_title: uc.title })
                }).catch(() => {});
              }}
              disabled={isGenerating}
              style={{
